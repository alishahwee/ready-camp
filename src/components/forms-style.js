...
export const Input = tw.input`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight`;
...
export const SubmitBtn = tw.button`bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-full`;
